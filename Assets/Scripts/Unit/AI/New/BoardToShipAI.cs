...
public class BoardToShipAI : MoveToTargetAI, IAIController
{
    public BoardToShipAI(UnitAIController controller, MovableUnit target) : base(controller, target)
    {
    }
    ...
    public override void OnCloseToTarget()
    {
